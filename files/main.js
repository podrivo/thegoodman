...
/*! StyleFix 1.0.3 & PrefixFree 1.0.7 - @author Lea Verou */
...
/*! rotator.js - http://josephfinsterwald.com */
(function(a){a.rotate=function(b){return a.rotate13(a.rotate5(b))};a.rotate5=function(g){var d=[],j,f=g.length,e="0".charCodeAt(),h=e+10;while(f--){j=g.charCodeAt(f);if(j>=e&&j<h){d[f]=String.fromCharCode(((j-e+5)%(10))+e)}else{d[f]=g.charAt(f)}}return d.join("")};a.rotate13=function(h){var e=[],l,g=h.length,f="a".charCodeAt(),k=f+26,d="A".charCodeAt(),j=d+26;while(g--){l=h.charCodeAt(g);if(l>=f&&l<k){e[g]=String.fromCharCode(((l-f+13)%(26))+f)}else{if(l>=d&&l<j){e[g]=String.fromCharCode(((l-d+13)%(26))+d)}else{e[g]=h.charAt(g)}}}return e.join("")}})(jQuery);
